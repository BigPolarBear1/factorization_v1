...
correction: actually working out the details.. I don't even need to do gaussian elimination in gf(2).. I just need to find 0 coefficient solutions in mod p that are also 0 in mod p^n... then combine those into composites to generate squares.. and we're done. Next thursday I will release the proof-of-concept. If you want to stop it, then do right to my former manager.
