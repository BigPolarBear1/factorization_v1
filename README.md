...
For the lower square, for any prime, we can look at coefficient solutions and calculated how many times N has to be subtracted mod p to reach 0 (just a linear congruence). Which is quite useful... because then we have a quick way to both generate squares in the upper square and lower square while its bounded by a factor base... I just have to fucking work out the details and write the code. Fuck. I know this is the correct approach. It's all suddenly starting to connect in my head. Like I finally woke up and regained my focus. I see it in my head now. The structure of it all.
