...
Ok I got it. Can just generate smooth numbers, by looking at how much N needs to be subtracted from the coefficient to reach 0. And the roots should contain all the other information I need to get it to work. Its this relation between the roots and coefficients. Almost there now.

edit: Fuck. Trying to work out the details.
So we have a upper square and a lower square. Where the lower squares is N*i subtracted from the upper square. We know which primes the upper square can be composed of if they have a 0 coefficient solution (aka x^2 = N mod p).
For the lower square, for any prime, we can look at coefficient solutions and calculated how many times N has to be subtracted mod p to reach 0 (just a linear congruence). Which is quite useful... because then we have a quick way to both generate squares in the upper square and lower square while its bounded by a factor base... I just have to fucking work out the details and write the code. Fuck. I know this is the correct approach. It's all suddenly starting to connect in my head. Like I finally woke up and regained my focus. I see it in my head now. The structure of it all. You know its funny, because today, working it all out in my head I realized I literally had all the number theoretical tools worked out and published in my paper.. everything I need.. fuck my life, why didn't I see this earlier. No time to waste now, got to move fast and finish this now. I know how to generate smooths in the lower square, I know how to generate smooths in the upper square.. I just know this massively improves QS, just need to go through the details now.
